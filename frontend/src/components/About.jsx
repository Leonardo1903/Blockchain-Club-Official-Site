    ...
    <div className="bg-black">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          <div className="max-w-max rounded-full border bg-black p-1 px-3">
            <p className="text-xs font-semibold leading-normal md:text-sm text-white">
              About the company
            </p>
          </div>
        ...
        <div className="flex flex-col items-center gap-x-4 gap-y-4 py-16 md:flex-row">
          <div className="space-y-6">
            <div className="max-w-max rounded-full border bg-black p-1 px-3">
              <p className="text-sm font-semibold md:text-base text-white">
                Join our team &rarr;
              </p>
            </div>
